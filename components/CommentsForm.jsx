...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            ...
            <div className="mt-8">
                <button type="button" onClick={handlePostSubmission} className='transition duration-500 ease hover:bg-transparent hover:text-black hover:border border-black border-5 inline-block bg-logoblue text-lg rounded-lg text-white px-6 py-2 cursor-pointer'>Post Comment</button>
                {showSuccessMessage && <span className="text-lg float-right mt-3 text-logoblue">Comment submitted for review</span>}
            </div>
        </div>
    );
};
