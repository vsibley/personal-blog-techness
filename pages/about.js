        ...
        <>
            <div className="max-w-7xl mx-auto">
                ...
                <div className="overflow-hidden lg:flex lg:items-center pt-12 md:pt-[4rem] pb-10">
                    <div className="max-w-xl md:max-w-xl lg:max-w-sm xl:max-w-2xl lg:pt-0 px-4 md:px-6 ">
                        <h2 className="text-3xl font-extrabold sm:text-4xl">
                            <span className="block">
                                Hey, I&apos; m Vanessa.</span>
                        </h2>
                        <p className="text-sm mt-4 text-gray-900">
                            I&apos;m usually over-caffeinated and have a smile on my face.<span className='font-bold'>Tech-Ness</span> is where I&apos;ll be documenting my journey into Web Development. I&apos;m a 29 year old stay-at-home Mom that decided to make a career change.</p>

                        <p className="text-sm mt-4 text-gray-900">Before starting this journey I had never written a line of code in my entire life. Not unless you count making my Myspace font <span className='font-bold'>bold</span> in middle school. I started this space to share the things I&apos;ve learned, this mistakes I&apos;ve made and the things I wished I knew from the start.
                        </p>
                        ...
                        <ul className="pt-7">
                            ...
                            <li className="pt-3">
                                <p className="mt-2 text-base leading-5 text-gray-600">
                                    <VscCircleFilled className='inline text-xs' />
                                    Interviews with Senior Developers and other bootcamp graduates.
                                </p>
                            </li>
                            <li className="pt-3">
                                <p className="mt-2 text-base leading-5 text-gray-600">
